...
import ProfileSecion from '../components/ProfileSection/ProfileSection.jsx';
...
const router = createBrowserRouter(
  createRoutesFromElements( 
    <Route path='/' element={<App />}>
        ...
        <Route path="matches/moredetails" element={<AuthenticatedRoute auth={true}><ProfileSecion editing={false}/></AuthenticatedRoute>}/>
        <Route path="messages/moredetails" element={<AuthenticatedRoute auth={true}><ProfileSecion editing={false}/></AuthenticatedRoute>}/>
